...
const StateMap = dynamic(() => import("../components/StateMap"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-[460px] bg-slate-900 border border-slate-800 rounded-xl flex items-center justify-center font-mono text-xs text-slate-500 animate-pulse">
...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 space-y-6">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-900/95 to-brand-navy p-6 sm:p-8 rounded-2xl border border-slate-800 shadow-2xl flex flex-col items-center text-center">
        ...
        <div className="relative z-10 flex flex-col items-center space-y-4 max-w-4xl">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-2xl sm:text-4xl font-extrabold font-mono tracking-tight text-white leading-tight">
