  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 space-y-6 font-mono">
          ...
          <button
            ...
            className={`p-4 rounded-xl border text-left transition-all ${
              selectedPillarId === p.pillarId
                ? "bg-[#182438] border-[#38bdf8] shadow-xl shadow-[#38bdf8]/10"
                : "bg-[#131d2c] border-[#28394e] hover:border-[#38bdf8]/50 hover:bg-[#182438]/80"
            }`}
          >
      ...
      <div className="bg-[#131d2c] border border-[#28394e] rounded-2xl p-6 shadow-2xl space-y-6">
        ...
        {/* Pillar Header */}
        <div className="border-b border-[#28394e] pb-4 space-y-2">
        ...
        <div className="bg-[#0b1320] border border-[#f43f5e]/40 p-4 rounded-xl space-y-1.5 text-xs">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {activePillar.telemetryEvidenceMetrics.map((met, idx) => (
              <div key={idx} className="bg-[#0b1320] p-4 rounded-xl border border-[#28394e] space-y-2 text-xs">
                ...
                <div className="bg-[#182438] p-2 rounded text-[10px] text-[#38bdf8] flex justify-between">
                  <span>Deviation:</span>
                  <span className="font-bold">{met.deviationZScore}</span>
                </div>
                <div className="text-[10px] text-[#64748b] pt-1 border-t border-[#28394e]">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="space-y-4">
            {activePillar.competitorAllocations.map((comp) => (
              <div key={comp.stateCode} className="bg-[#0b1320] p-5 rounded-xl border border-[#28394e] space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#28394e] pb-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 border-t border-[#28394e] text-xs">
                  <div className="bg-[#182438] p-2.5 rounded border border-[#28394e]">
