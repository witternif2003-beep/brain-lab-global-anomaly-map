...
export default function CountyMatrixPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 space-y-6 font-mono">
      ...
      {/* Filter Bar */}
      <div className="flex items-center space-x-2 overflow-x-auto glass-card p-2.5 rounded-xl border border-white/10 text-xs">
      ...
      <div className="glass-panel border border-white/10 rounded-2xl p-6 shadow-2xl space-y-4">
        ...
        <div className="space-y-3">
          {filtered.map((c) => (
            <div key={c.fips} className="glass-card p-4 rounded-xl border border-white/10 space-y-2">
              ...
              <div className="glass-panel/90 p-3 rounded-lg border border-white/10 text-xs space-y-1">
              ...
              <div className="bg-sky-950/30 border border-sky-800/40 p-2.5 rounded-lg text-xs text-sky-300 flex items-center justify-between">
