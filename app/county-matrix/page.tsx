...
export default function CountyMatrixPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 space-y-6 font-mono">
      ...
      {/* Filter Bar */}
      <div className="flex items-center space-x-2 overflow-x-auto bg-slate-950 p-2.5 rounded-xl border border-slate-800 text-xs">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl space-y-4">
        ...
        <div className="space-y-3">
          {filtered.map((c) => (
            <div key={c.fips} className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-2">
